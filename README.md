...
`Python` `FastAPI` `PostgreSQL` `pgvector` `Redis` `Celery` `HDBSCAN` `Ollama`

An AI-powered platform for analyzing production incidents across logs, metrics, traces and deployment events.

**Highlights**

- 🔍 Telemetry-driven anomaly detection
- 🧠 HDBSCAN-based incident clustering
- 🌐 Topology-aware Root Cause Analysis
- 📚 RAG pipeline for historical incident retrieval
- 🤖 Tool-using AI agent for grounded incident analysis
- 🗄️ PostgreSQL + pgvector for semantic retrieval

➡️ **[View Repository](YOUR_INCIDENTIQ_REPO_URL)**

---

### 🌾 Namma Connect

**AI-Powered Agritourism Marketplace**

`Python` `FastAPI` `React` `PostgreSQL` `Redis` `pgvector` `Gemini` `Docker`

A full-stack marketplace combining agritourism, bookings and AI-powered recommendations.

**Highlights**

- 🔐 JWT authentication and role-based access control
- ⚡ Asynchronous workflows and Redis caching
- 🔎 Semantic retrieval using embeddings and pgvector
- 🤖 RAG-powered personalized recommendations
- 🗺️ AI-generated itineraries
- 🐳 Dockerized development environment

➡️ **[View Repository](https://github.com/priyanshu130018/Namma-Connect.git)**
...
`Python` `FastAPI` `React` `TMDB API`

A personalized movie discovery platform using a hybrid recommendation approach.
...
➡️ **[View Repository](https://github.com/priyanshu130018/WatchMan.git)**
...
📧 **Email:** 13vermapriyanshu@gmail.com
